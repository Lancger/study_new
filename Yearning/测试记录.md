...
修改字段
alter table mytable1 modify column myname varchar(50) ;

增加字段
alter table mytable1 add sex varchar（10);

##########
DDL操作是隐性提交的！不能rollback 

#建表操作
create table bak(id int UNSIGNED not null primary key auto_increment,
                  name varchar(45),
                  price float)engine=INNODB DEFAULT CHARSET=utf8 auto_increment=1;
                  
模拟插入了2条数据                 
INSERT INTO bak(id, name, price) VALUES (1,'good1',14);
INSERT INTO bak(id, name, price) VALUES (2,'good2',14);
